                                    ...
                                    <tr>
                                        <td class="cart-pic first-row">
                                            <a href="{{route('san-pham', $orderdetail->product->slug)}}">
                                                 <img src="{{asset('uploads/product_des/'.$orderdetail->product->image)}}" alt="" style="width:100px;height: 120px;">
                                            </a>
                                        </td>
                                        ...
                                        <td class="p-price first-row">
                                            ...
                                            {{number_format($orderdetail->product->discount).',000'}} <sup>đ</sup>
                                            @else
                                            {{number_format($orderdetail->product->price).',000'}} <sup>đ</sup>
                                            @endif 
                                        </td>
                                        <td class="p-price first-row">
                                            {{number_format($orderdetail->total).',000'}} <sup>đ</sup>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
