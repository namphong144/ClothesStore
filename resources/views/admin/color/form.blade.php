                    ...
                    <form method="post" action="{{route('color.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="name" id="slug" placeholder="Tên color" type="text"
                                    class="form-control" value="{{isset($color) ? $color->name : ''}}">
                                    @error('name')
                        ...
                        <div class="position-relative row form-group mb-1">
                            <div class="col-md-9 col-xl-8 offset-md-2">
                                <a href="{{route('color.index')}}" class="border-0 btn btn-outline-danger mr-1">
