        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <p>Từ ngày: <input type="text" id="datepicker" class="form-control" name="datepicker"></p>
                        </div>
                        <div class="col-md-2">
                            <p>Đến ngày: <input type="text" id="datepicker2" class="form-control" name="datepicker2"></p>
                        </div>
                        <div class="col-md-2">
                            <p></p>
                            <p></p>
                            <button type="submit" id="btn-filter" class="btn btn-primary btn-sm">Lọc</button>
                        </div>
                    </div>
                </form>
